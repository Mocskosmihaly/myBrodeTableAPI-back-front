  ...
  <div class="max-w-lg ml-10 py-10">
    ...
    <form @submit.prevent="addRecord">
      ...
      <div class="mb-6">
        ...
        <select-set v-model="selectedEff" label-name="EFFECT" :options="effectOptions" />
      ...
      <div class="mb-6">
        ...
        <radio-set v-model="selected" label-name="PATHS" :options="pathOptions" />
      ...
      <li class="py-4" v-for="record in records" :key="record.id" :record="record">
        <div class="flex items-center justify-between flex-wrap">
          <div class="flex-1 flex justify-between flex-wrap pr-4">
            ...
            <p class="block font-mono font-semibold">{{ getTemplate(record) }}</p>
          </div>
        ...
        <div v-if="record == editedRecord">
          <form action @submit.prevent="updateRecord(record)">
            <div class="mb-6 p-4 bg-white rounded border border-grey-light mt-4">
              ...
              <div class="mb-6">
                <select id="template_update" class="select" v-model="record.template">
                  <option disabled value>Select an template</option>
                  <option
                    :value="template.id"
                    v-for="template in templates"
